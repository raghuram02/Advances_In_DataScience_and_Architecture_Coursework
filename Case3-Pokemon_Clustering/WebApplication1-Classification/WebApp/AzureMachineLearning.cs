...
namespace CallRequestResponseService
{
    ...
    class AzureMachineLearning
    {

        public static string PredictPolarity(PredictPolarityClass textPolarity)
        {
            using (var client = new HttpClient())
            {
                    ...
                    Inputs = new Dictionary<string, StringTable>() {
                        {
                            ...
                            new StringTable()
                            {
                                ...
                                Values = new string[,] { { textPolarity.text }, }
                            }
                        },
                    },
                ...
                const string apiKey = "S3fjrtpENJsESYoXoTnpZXJPg4+X2wh8oKI476gZdgdVrCRcUJFFV3VdLNTnsvvKZU6WuAimSp2Oj0L3dVA2Ew=="; // Replace this with the API key for the web service
